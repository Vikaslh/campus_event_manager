...
import { Plus, Edit, Trash2, Users, MapPin, Calendar, QrCode, UserCheck } from 'lucide-react';
...
interface EventListProps {
  ...
  onViewRegistrations?: (event: EventWithStats) => void;
}
          ...
          <Card key={event.id} className="space-y-4">
            <div className="flex justify-between items-start">
              <div className="space-y-2">
                ...
                <Badge variant={getTypeColor(event.type) as "primary" | "secondary" | "danger" | "success" | "warning"}>
                  {event.type}
                </Badge>
              </div>
